...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("object_key", sa.String(length=50000), nullable=False, unique=True),
    ...
    op.create_table(
        ...
        sa.Column("result_object_key", sa.String(length=50000), nullable=True),
        sa.Column("csv_object_key", sa.String(length=50000), nullable=True),
        sa.Column("xlsx_object_key", sa.String(length=50000), nullable=True),
